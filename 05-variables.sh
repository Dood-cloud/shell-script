...
echo "$NAME2 : Ok then $NAME1 assign it to me. I will try to complete it asap."
echo "$NAME1: Thank you $NAME2. You are always and had been the savior of last resort"
